        ...
        <div class="bg-white w-full max-w-md shadow-lg p-6 overflow-y-auto rounded-t-xl max-h-[90vh]" @click.stop>
          ...
          <div class="space-y-6">
            <div class="text-gray-600">
              Aquí puedes agregar el formulario o los campos necesarios para subir un nuevo diseño.
            </div>
            ...
            <!-- Botón de acción -->
            <button class="w-full bg-purple-700 hover:bg-purple-800 text-white py-2 rounded-lg font-semibold"
              @click="submitDesign">
              Guardar diseño
            </button>
          </div>
...
function submitDesign() {
  // Aquí va la lógica para guardar el diseño
