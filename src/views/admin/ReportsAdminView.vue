      ...
      >
        ...
        >
          <template #actions>
            ...
            <button
              class="mt-2 px-2 py-1 bg-yellow-400 text-gray-900 rounded hover:bg-yellow-500 text-xs"
            ...
            <button
              class="mt-2 px-2 py-1 bg-gray-400 text-white rounded hover:bg-gray-500 text-xs"
              @click="rejectReport(tattoo.id)"
            >
              <div class="flex">
                <svg
