                    ...
                    <div class="w-full max-w-7xl rounded-xl shadow-lg p-2 md:p-5 bg-[#7B6EAD]">
                        <div v-if="user" class="bg-white rounded-lg p-6 shadow-lg">
                            ...
                            <div class="flex flex-col md:flex-row items-center gap-6 mb-8">
                                ...
                                <div class="flex flex-col md:flex-col items-center gap-4 px-4">
                                    <button @click="goToEditUser(user.id)"
                                        class="mt-4 md:mt-0 px-4 py-2 bg-[#2E076B] text-white rounded hover:bg-purple-900 cursor-pointer flex items-center justify-center gap-2"
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-3 items-center flex-wrap">
                                            <a v-if="user.whatsapp" :href="`https://wa.me/${user.whatsapp}`"
                                                target="_blank" class="text-green-600 flex items-center">
                                    ...
                                    <div class="max-h-[420px] overflow-y-auto">
                                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            <div v-for="diseño in user.diseños || []" :key="diseño.id"
                                                class="bg-[#7B6EAD] rounded p-2 flex flex-col items-center">
                                                <img :src="diseño.imagen" alt="Diseño"
                                                    class="w-full h-40 object-cover rounded mb-2" />
                                                <span class="text-xs text-white">{{ diseño.nombre }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="max-h-[420px] overflow-y-auto">
                                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            <div v-for="img in user.portafolio || []" :key="img"
                                                class="bg-[#7B6EAD] rounded p-2 flex items-center justify-center">
