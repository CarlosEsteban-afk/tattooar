  <template>
    ...
    <div class="flex flex-col h-screen items-center">
        ...
        <div class="flex flex-wrap items-start justify-center gap-6 px-4 pb-2">
          ...
          <div class="flex flex-col min-[360px]:flex-row gap-4 items-start min-w-[300px] max-w-[500px] w-full relative">
            ...
            <div class="flex flex-col items-center min-[360px]:items-center">
              <h1 class="text-md font-semibold mb-2 text-center min-[360px]:text-left">Alias</h1>
              <div class="w-20 h-20">
            ...
            <div class="flex flex-col flex-1 relative w-full">
              ...
              <div class="flex items-center justify-between">
                ...
                <button @click="openStyleDrawer" class="text-lg font-bold text-purple-600">+</button>
              </div>
              ...
              <div class="flex items-center justify-between mt-2">
                ...
                <button @click="openCityDrawer" class="text-lg font-bold text-purple-600">+</button>
              </div>
      ...
      <div class="flex-1 overflow-y-auto flex flex-col pt-4 w-full px-4 max-w-6xl scrollbar-hide">
        <!-- Disponibles -->
        <div class="mb-4">
          <div class="flex flex-row justify-between items-center mb-2">
            <p class="font-bold text-base">Disponibles</p>
            <button class="text-xl font-bold" @click="openDrawerFor('disponibles')">+</button>
          </div>
        ...
        <div>
          <div class="flex flex-row justify-between items-center mb-2">
            ...
            <button class="text-xl font-bold" @click="openDrawerFor('portafolio')">+</button>
          </div>
          <div class="grid grid-cols-1 min-[360px]:grid-cols-3 gap-4 max-h-[18rem] overflow-y-auto scrollbar-hide">
      ...
      <div class="bg-white rounded-lg shadow-lg p-4 w-80 max-w-md">
        ...
        <div class="flex justify-end space-x-4">
          <button @click="showDeactivateModal = false"
            class="px-2 py-1 text-red-600 rounded hover:bg-gray-300">
            Cancelar
          </button>
  ...
  const currentSection = ref('disponibles') // o 'portafolio'
